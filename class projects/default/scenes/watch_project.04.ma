...
//Name: watch_project.04.ma
//Last modified: Tue, Sep 08, 2020 12:33:17 PM
//Codeset: 1252
requires maya "2020";
...
fileInfo "UUID" "5E2A8FF0-46FB-F204-344E-C59D71EF71D4";
createNode transform -s -n "persp";
	rename -uid "4D97761B-4F85-03C3-DC9D-5A89673A604E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 28.612956639718558 40.221801878014539 17.198364998074187 ;
	setAttr ".r" -type "double3" -48.33835272827929 419.79999999970471 -6.3229196033718131e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "5B7C062B-4285-FD5E-CDA5-1796492B1092";
	setAttr -k off ".v" no;
	setAttr ".pze" yes;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 49.902291172155579;
