...
//Name: watch_project.04.0001.ma
//Last modified: Tue, Sep 08, 2020 12:31:13 PM
//Codeset: 1252
requires maya "2020";
currentUnit -l centimeter -a degree -t film;
fileInfo "exportedFrom" "C:/Users/dwmbs/Documents/maya/projects/default/scenes/watch_project.04.ma";
fileInfo "application" "maya";
fileInfo "product" "Maya 2020";
fileInfo "version" "2020";
fileInfo "cutIdentifier" "201911140446-42a737a01c";
fileInfo "osv" "Microsoft Windows 10 Technical Preview  (Build 18363)\n";
fileInfo "UUID" "47F9F81A-494D-78CA-1DE4-FB8470773C10";
createNode transform -s -n "persp";
	rename -uid "4D97761B-4F85-03C3-DC9D-5A89673A604E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.84354311401042259 3.3709581748447142 0.80420527035253087 ;
	setAttr ".r" -type "double3" -55.538352728511192 369.79999999984074 2.4207396904039106e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "5B7C062B-4285-FD5E-CDA5-1796492B1092";
	setAttr -k off ".v" no;
	setAttr ".pze" yes;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 2.7705040965090815;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0.57670532702317112 1.0866632909404152 -0.74062074819412083 ;
...
createNode transform -n "pCube10";
	...
	setAttr ".spt" -type "double3" 5.351507087255451e-17 0.53145788883979117 -5.3541223050790163e-16 ;
...
createNode transform -n "pCube12";
	...
	setAttr ".t" -type "double3" -0.056396288713003062 2.9406331225686375 0.5124031401596526 ;
...
// End of watch_project.04.0001.ma
