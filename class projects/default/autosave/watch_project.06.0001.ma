...
//Name: watch_project.06.0001.ma
//Last modified: Sat, Sep 12, 2020 01:56:00 PM
//Codeset: 1252
requires maya "2020";
...
fileInfo "UUID" "4E778B5D-47BB-E48E-32E5-CCAD9EF08B8E";
createNode transform -s -n "persp";
	rename -uid "4D97761B-4F85-03C3-DC9D-5A89673A604E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 8.4161008370937651 6.2819908302607761 10.483829937957806 ;
	setAttr ".r" -type "double3" -22.53835275154805 756.59999999987701 -9.9043517977149821e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "5B7C062B-4285-FD5E-CDA5-1796492B1092";
	setAttr -k off ".v" no;
	setAttr ".pze" yes;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 13.348254113722366;
...
createNode transform -n "watch_face" -p "pCylinder4";
	...
	setAttr ".t" -type "double3" 0 3.6804344373104159 0 ;
...
// End of watch_project.06.0001.ma
