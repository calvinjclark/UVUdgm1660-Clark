...
//Name: watch_project.03.0003.ma
//Last modified: Tue, Sep 08, 2020 12:10:59 PM
//Codeset: 1252
requires maya "2020";
...
fileInfo "UUID" "0D8780A2-4626-42BA-64D1-95A04DC18765";
createNode transform -s -n "persp";
	rename -uid "4D97761B-4F85-03C3-DC9D-5A89673A604E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 3.974354015799638 -1.7189588766654349 0.13188176888489683 ;
	setAttr ".r" -type "double3" -4.5383527296498487 86.599999999994125 6.70365276462289e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "5B7C062B-4285-FD5E-CDA5-1796492B1092";
	setAttr -k off ".v" no;
	setAttr ".pze" yes;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 4.1081835196954337;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -0.11374023224704999 -2.044024632810407 -0.11099578208715744 ;
...
createNode transform -n "pCylinder2";
	...
	setAttr ".t" -type "double3" -0.11374008617488673 -2.044024632810407 -0.11099563601499457 ;
...
createNode transform -n "pCylinder3";
	...
	setAttr ".t" -type "double3" 3.2702751941082995 0.42098474891323301 -0.092687075545034386 ;
...
// End of watch_project.03.0003.ma
