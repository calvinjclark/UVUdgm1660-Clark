...
//Name: watch_project.06.0003.ma
//Last modified: Sat, Sep 12, 2020 02:36:24 PM
//Codeset: 1252
requires maya "2020";
...
fileInfo "UUID" "857BC1DC-4698-BB26-E607-579CD110FAC7";
createNode transform -s -n "persp";
	rename -uid "4D97761B-4F85-03C3-DC9D-5A89673A604E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.99749120838075278 12.833257841011404 7.0696526586020205 ;
	setAttr ".r" -type "double3" -60.938352751770431 1079.3999999996681 -7.454833787947163e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "5B7C062B-4285-FD5E-CDA5-1796492B1092";
	setAttr -k off ".v" no;
	setAttr ".pze" yes;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 13.348254113722277;
...
createNode transform -n "polySurface1" -p "watch_body";
	rename -uid "EAABE054-40F2-2680-D315-C5A088900EDA";
createNode mesh -n "polySurfaceShape1" -p "polySurface1";
	rename -uid "F082C048-4FC4-0DA9-A914-DD961AD945DC";
	setAttr -k off ".v";
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.42916661500930786 0.50046992301940918 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
createNode transform -n "polySurface2" -p "watch_body";
	rename -uid "BA2094E2-46BE-2A57-3E0E-6B82CDDA5B58";
createNode mesh -n "polySurfaceShape2" -p "polySurface2";
	rename -uid "CBD49928-478E-1E6C-5121-E5B1DDAE189E";
	setAttr -k off ".v";
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.43679553270339966 0.202170729637146 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 5 ".pt";
	setAttr ".pt[1]" -type "float3" 3.7252903e-09 -1.4901161e-08 -2.0861626e-07 ;
	setAttr ".pt[6]" -type "float3" -0.27574253 0 2.9802322e-08 ;
	setAttr ".pt[7]" -type "float3" 0 -2.3841852e-07 1.8626451e-08 ;
	setAttr ".pt[8]" -type "float3" 1.4901161e-08 -1.1920929e-07 0 ;
	setAttr ".pt[10]" -type "float3" 6.7055225e-08 0 0 ;
createNode transform -n "polySurface3" -p "watch_body";
	rename -uid "18CA76D7-4862-6DDF-9A3F-C48D6934B1A5";
createNode mesh -n "polySurfaceShape3" -p "polySurface3";
	rename -uid "78BD415F-4A00-07E2-B0FD-59B5E3599D0E";
	setAttr -k off ".v";
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode transform -n "transform2" -p "watch_body";
	rename -uid "B6B11CA5-4FEE-4B3C-714E-D0996F667761";
	setAttr ".v" no;
...
createNode transform -n "polySurface4" -p "watch_body";
	rename -uid "DE2028C8-41C6-C1B9-D34B-02A24F4CAB63";
	setAttr ".s" -type "double3" 1 1 -1 ;
createNode mesh -n "polySurfaceShape4" -p "polySurface4";
	rename -uid "BC377F06-4B3C-96CC-02E6-8C84D2544340";
	setAttr -k off ".v";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 12 ".vt[0:11]"  0.50000006 -1.000000238419 1.23748255 0.63031334 -0.94198859 1.22916436
		 0.63031334 0.94198823 1.22916436 0.50000006 1 1.23748255 0.71190107 -0.88984537 1.015720963
		 0.71190107 0.88984489 1.015720963 0.50000006 -1.000000238419 0.86602557 0.6691308 -1.000000238419 0.74314493
...
createNode transform -n "polySurface5" -p "watch_body";
	rename -uid "9C6EC87D-4DEA-6FD5-5B4B-BD9E45D6DF62";
	setAttr ".s" -type "double3" 1 1 -1 ;
createNode mesh -n "polySurfaceShape5" -p "polySurface5";
	rename -uid "DAF69E63-4EFF-556A-D6FA-77A6EB24A6A6";
	setAttr -k off ".v";
	...
	setAttr ".pv" -type "double2" 0.43679553270339966 0.202170729637146 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr -s 21 ".uvst[0].uvsp[0:20]" -type "float2" 0.43679553 0.20217073
		 0.44772416 0.2143082 0.3954483 0.2723664 0.37359104 0.24809146 0.46093747 0.22390825
		 0.42187497 0.29156652 0.51666653 0.3125 0.52499986 0.3125 0.52499986 0.68843985 0.51666653
		 0.68843985 0.53333318 0.3125 0.53333318 0.68843985 0.37359104 0.24809146 0.43679553
		 0.20217073 0.46093747 0.22390825 0.42187497 0.29156652 0.52499986 0.68843985 0.51666653
		 0.68843985 0.51666653 0.3125 0.53333318 0.3125 0.53333318 0.68843985;
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	...
	setAttr ".pt[8]" -type "float3" 1.4901161e-08 -1.1920929e-07 0 ;
	setAttr ".pt[10]" -type "float3" 6.7055225e-08 0 0 ;
	setAttr -s 16 ".vt[0:15]"  -0.63031346 -0.94198859 1.22916448 -0.71190131 -0.88984537 1.015721083
		 -0.50000018 -1.000000238419 1.23748291 -0.63031346 0.94198823 1.22916448 -0.71190137 0.88984489 1.015721083
		 -0.50000024 1 1.23748291 -0.40450862 -1.000000238419 0.7218284 -0.58274853 -1.000000238419 0.80005342
		 -0.49818316 -1.000000238419 0.86149359 -0.80901736 -1.000000238419 0.58778542 -0.40450868 -1.000000238419 0.29389271
		 -0.25000024 -1.000000238419 0.43301287 -0.50000024 -1.000000238419 0.86602581 -0.66913092 1 0.74314511
		 -0.80901736 1 0.58778542 -0.50000024 1 0.86602581;
	setAttr -s 25 ".ed[0:24]"  7 0 1 9 1 0 1 0 0 6 1 1 12 2 0 8 2 0 0 2 0
		 13 3 1 0 3 1 14 4 0 4 3 0 1 4 0 15 5 0 2 5 0 3 5 0 6 7 0 7 8 0 10 9 0 10 6 0 11 12 0
		 11 8 0 14 13 0 9 14 0 12 15 0 13 15 0;
...
createNode polyChipOff -n "polyChipOff2";
	rename -uid "ED1237E4-4421-0F0E-1824-41818F683CAF";
	setAttr ".ics" -type "componentList" 5 "f[17:18]" "f[47:48]" "f[54:55]" "f[241]" "f[243:253]";
	setAttr ".ix" -type "matrix" 3.3060124416609011 0 0 0 0 0.43595345415475351 0 0 0 0 3.0993866606213389 0
		 -0.015448519063197663 0.64112473109422574 -0.11586389297397914 1;
	setAttr ".ws" yes;
	setAttr ".pvt" -type "float3" -0.015449012 0.64112467 2.9204679 ;
	setAttr ".rs" 51720;
	setAttr ".dup" no;
createNode polyTweak -n "polyTweak3";
	rename -uid "BD5C54E2-4802-D103-3FCB-18A992C7D6C6";
	setAttr ".uopa" yes;
	setAttr -s 32 ".tk";
	setAttr ".tk[17]" -type "float3" 7.4505806e-09 0 1.1175871e-08 ;
	setAttr ".tk[18]" -type "float3" 0 0 1.4901161e-08 ;
	setAttr ".tk[19]" -type "float3" -1.1059456e-07 0 2.9802322e-08 ;
	...
	setAttr ".tk[240]" -type "float3" 8.9406967e-08 0 3.7252903e-09 ;
	setAttr ".tk[241]" -type "float3" -0.24818297 0 0.00054523209 ;
	setAttr ".tk[242]" -type "float3" 0.03881745 0.058011703 0.058083795 ;
	setAttr ".tk[243]" -type "float3" 0.097116038 0.11015499 -6.8429915e-09 ;
	setAttr ".tk[244]" -type "float3" -0.248183 0 0.00054511288 ;
	setAttr ".tk[245]" -type "float3" 8.1956387e-08 0 -0.056478657 ;
	setAttr ".tk[246]" -type "float3" 0.03881745 -0.058011703 0.058083795 ;
	setAttr ".tk[247]" -type "float3" 0.097116008 -0.11015499 -6.8429915e-09 ;
	setAttr ".tk[248]" -type "float3" 0 0 -0.056478649 ;
	setAttr ".tk[249]" -type "float3" 0 0 -0.056478649 ;
	setAttr ".tk[250]" -type "float3" -0.03881745 0.058011703 0.05808378 ;
	setAttr ".tk[251]" -type "float3" -0.03881745 -0.058011703 0.05808378 ;
	setAttr ".tk[252]" -type "float3" 0 0 -0.056478649 ;
	setAttr ".tk[253]" -type "float3" -0.097116008 0.11015499 6.842988e-09 ;
	setAttr ".tk[254]" -type "float3" -0.097116008 -0.11015499 6.842988e-09 ;
createNode polySeparate -n "polySeparate2";
	rename -uid "1BD7A180-4129-0E17-66A2-FEAEB42381AE";
	setAttr ".ic" 3;
	setAttr -s 3 ".out";
createNode groupId -n "groupId6";
	rename -uid "591A073D-46A1-C1EC-A896-FD9B1461BFEC";
	setAttr ".ihi" 0;
createNode groupParts -n "groupParts4";
	rename -uid "3862466B-4D4B-0F64-8A13-66973366C335";
	setAttr ".ihi" 0;
...
createNode groupId -n "groupId7";
	rename -uid "47216416-4D16-088B-3648-59B5122FF3C9";
	setAttr ".ihi" 0;
createNode groupParts -n "groupParts5";
	rename -uid "249B7A8F-49EC-65FC-7E24-DCA1614B7285";
	setAttr ".ihi" 0;
	setAttr ".ic" -type "componentList" 10 "f[0]" "f[1]" "f[2]" "f[3]" "f[4]" "f[5]" "f[6]" "f[7]" "f[8]" "f[9]";
createNode groupId -n "groupId8";
	rename -uid "2048C024-4219-59C4-13A6-5BB42BCC94A6";
	setAttr ".ihi" 0;
createNode groupParts -n "groupParts6";
	rename -uid "3535A264-4FE8-B542-0C2B-BE8A88C6F352";
	setAttr ".ihi" 0;
	setAttr ".ic" -type "componentList" 8 "f[0]" "f[1]" "f[2]" "f[3]" "f[4]" "f[5]" "f[6]" "f[7]";
createNode polyTweak -n "polyTweak4";
	rename -uid "84C57933-4BF9-4865-026C-BA84D92BB2B8";
	setAttr ".uopa" yes;
	setAttr -s 9 ".tk";
	setAttr ".tk[47]" -type "float3" -3.7252903e-09 0 0 ;
	setAttr ".tk[240]" -type "float3" -0.34326139 0 -0.059713975 ;
createNode deleteComponent -n "deleteComponent2";
	rename -uid "679C6088-489B-84E1-D1BE-F39070FE073F";
	setAttr ".dc" -type "componentList" 2 "f[30:31]" "f[37:38]";
createNode groupId -n "groupId9";
	rename -uid "B3D72FCA-4B70-729A-8185-7BAEE4550C42";
	setAttr ".ihi" 0;
createNode groupId -n "groupId10";
	rename -uid "01E31462-47A2-CE27-D0E2-C4BAA351F0CE";
	setAttr ".ihi" 0;
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
...
// End of watch_project.06.0003.ma
