...
//Name: watch_project.05.ma
//Last modified: Wed, Sep 09, 2020 12:10:25 PM
//Codeset: 1252
requires maya "2020";
...
fileInfo "UUID" "4EA00E50-471C-CC8A-2630-2FA4BE8DABC6";
createNode transform -s -n "persp";
	rename -uid "4D97761B-4F85-03C3-DC9D-5A89673A604E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 23.58100102216185 14.288604075102789 22.789497488414348 ;
	setAttr ".r" -type "double3" -22.53835272823493 765.39999999953818 -2.2648585432123944e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "5B7C062B-4285-FD5E-CDA5-1796492B1092";
	setAttr -k off ".v" no;
	setAttr ".pze" yes;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 34.236790994459646;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "4FB35BFE-4780-EDFC-30F1-F8890124BAC5";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "DB0F0C38-4DE8-C5A3-2FFD-689BD6945954";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "53159DA3-43F5-31A3-8707-25ACB5E4B32A";
createNode displayLayerManager -n "layerManager";
	rename -uid "DA967A67-426A-FF6C-4437-D7AB5CE55778";
	setAttr ".cdl" 1;
	setAttr ".dli[1]"  1;
	setAttr -s 2 ".dli";
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "86C6FBC7-4979-904A-9892-75A0008E003D";
