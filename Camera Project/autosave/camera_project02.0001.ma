...
//Name: camera_project02.0001.ma
//Last modified: Fri, Oct 30, 2020 10:13:05 AM
//Codeset: 1252
requires maya "2020";
...
fileInfo "UUID" "1C244505-4AB9-CF53-B825-66AC40DFBB21";
createNode transform -s -n "persp";
	rename -uid "1FF30DD1-4EF5-C0F4-03D8-E5B3294BD055";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 4.0178465419555334 6.7832205758140631 -8.6284252724651651 ;
	setAttr ".r" -type "double3" -24.938352729352967 154.99999999987881 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "49CB3CEF-4DF5-EF8D-72C5-FCA81DA84A14";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 9.5878179711818348;
...
createNode transform -s -n "top";
	...
	setAttr ".t" -type "double3" 0.093957821552766552 1000.1 0.14093673232914972 ;
...
createNode polyExtrudeFace -n "polyExtrudeFace1";
	...
	setAttr ".ws" yes;
	setAttr ".t" -type "double3" 0 0 -0.30848065685908765 ;
	setAttr ".pvt" -type "float3" -0.97800547 2.5177987 -1.1907486 ;
	setAttr ".rs" 38420;
	setAttr ".c[0]"  0 1 1;
...
// End of camera_project02.0001.ma
