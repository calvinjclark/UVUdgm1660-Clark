...
//Name: camera_project01.0002.ma
//Last modified: Fri, Oct 30, 2020 09:51:59 AM
//Codeset: 1252
requires maya "2020";
currentUnit -l centimeter -a degree -t film;
fileInfo "exportedFrom" "C:/Users/dwmbs/Desktop/school work uvu/camera project/Camera Project/scenes/camera_project01.ma";
fileInfo "application" "maya";
fileInfo "product" "Maya 2020";
fileInfo "version" "2020";
fileInfo "cutIdentifier" "201911140446-42a737a01c";
fileInfo "osv" "Microsoft Windows 10 Technical Preview  (Build 18363)\n";
fileInfo "UUID" "BEEAB6A4-4BF4-8B7A-2A4F-B59012261BCB";
createNode transform -s -n "persp";
	rename -uid "1FF30DD1-4EF5-C0F4-03D8-E5B3294BD055";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 21.605255657010876 9.6846677036024822 -21.724608917133253 ;
	setAttr ".r" -type "double3" -3.9383527294259748 130.19999999995983 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "49CB3CEF-4DF5-EF8D-72C5-FCA81DA84A14";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 31.805390089369769;
...
createNode transform -n "pCube1";
	...
	setAttr ".t" -type "double3" 0.26013929074114672 3.027059080553042 2.8615321981526485 ;
	setAttr ".s" -type "double3" 16.083147463478944 6.6656090250014186 3.9040739955802488 ;
...
createNode transform -n "pCylinder1";
	...
	setAttr ".t" -type "double3" -0.94285446771323989 2.4683924832922548 -2.4213683696898505 ;
	setAttr ".r" -type "double3" 90 0 0 ;
	setAttr ".s" -type "double3" 2.7649015439525413 3.3308642858051143 2.7649015439525413 ;
	setAttr ".rp" -type "double3" 0 3.3308636041792923 0 ;
	setAttr ".rpt" -type "double3" 0 -3.3308636041792923 3.3308636041792923 ;
	setAttr ".sp" -type "double3" 0 0.99999979536067518 0 ;
	setAttr ".spt" -type "double3" 0 2.3308638088186142 0 ;
...
createNode transform -n "pCube2";
	...
	setAttr ".t" -type "double3" -0.82456990130836338 7.3839955244865241 2.1271468945345693 ;
	setAttr ".s" -type "double3" 5.2888890433799407 2.0482633638549754 5.6802576305772128 ;
	setAttr ".rp" -type "double3" 0 -1.0241322432365239 0 ;
	setAttr ".sp" -type "double3" 0 -0.50000027404143732 0 ;
	setAttr ".spt" -type "double3" 0 -0.52413196919509208 0 ;
...
createNode transform -n "pCylinder2";
	...
	setAttr ".t" -type "double3" -5.998447853227578 6.6931964073236756 3.0076523645632229 ;
	setAttr ".s" -type "double3" 1.2228836059433794 0.3333333561446995 1.2228836059433794 ;
	setAttr ".rp" -type "double3" 0 -0.33333312607367549 0 ;
	setAttr ".sp" -type "double3" 0 -0.99999930978697549 0 ;
	setAttr ".spt" -type "double3" 0 0.66666618371330444 0 ;
...
createNode transform -n "pCube3";
	...
	setAttr ".t" -type "double3" 5.1566955904159402 6.741224500543411 2.8931597607232371 ;
	setAttr ".s" -type "double3" 4.8681480860905788 0.70933332903455149 3.7439637289021208 ;
...
createNode polyCube -n "polyCube1";
	rename -uid "F67FF0B4-4501-5471-4D60-FB842C7272F3";
	setAttr ".cuv" 4;
...
createNode polyCylinder -n "polyCylinder1";
	rename -uid "AF269806-4155-9CA6-16E2-E2830A420E25";
	setAttr ".sa" 18;
	setAttr ".sc" 1;
	setAttr ".cuv" 3;
createNode polyCube -n "polyCube2";
	rename -uid "CFE27970-4C34-A2DD-C100-2AB6BC184C5B";
	setAttr ".cuv" 4;
createNode polyCylinder -n "polyCylinder2";
	rename -uid "A8196020-4F20-7767-FC56-3BAE80C08F80";
	setAttr ".sa" 10;
	setAttr ".sc" 1;
	setAttr ".cuv" 3;
createNode polyCube -n "polyCube3";
	rename -uid "07383622-411F-601D-B8D6-219E98B03442";
	setAttr ".cuv" 4;
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
...
// End of camera_project01.0002.ma
