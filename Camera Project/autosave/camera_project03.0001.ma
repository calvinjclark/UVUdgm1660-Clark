...
//Name: camera_project03.0001.ma
//Last modified: Tue, Nov 03, 2020 11:17:47 AM
//Codeset: 1252
requires maya "2020";
currentUnit -l centimeter -a degree -t film;
fileInfo "exportedFrom" "C:/Users/dwmbs/Desktop/school work uvu/camera project/Camera Project/scenes/camera_project03.ma";
fileInfo "application" "maya";
fileInfo "product" "Maya 2020";
fileInfo "version" "2020";
fileInfo "cutIdentifier" "201911140446-42a737a01c";
fileInfo "osv" "Microsoft Windows 10 Technical Preview  (Build 18363)\n";
fileInfo "UUID" "1F5957D3-4CFB-51E2-C56B-9DB327FA8C79";
createNode transform -s -n "persp";
	rename -uid "1FF30DD1-4EF5-C0F4-03D8-E5B3294BD055";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.7273159036831589 2.7545756084555557 5.5827799092993331 ;
	setAttr ".r" -type "double3" 2.6616472706270904 -41.80000000000171 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "49CB3CEF-4DF5-EF8D-72C5-FCA81DA84A14";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 1.4995506318582363;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0.0092002667097264013 2.8931128498805139 4.9161042880361032 ;
...
createNode mesh -n "camera_lensShape" -p "camera_lens";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.42414513230323792 0.13755345344543457 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 5 ".pt";
	setAttr ".pt[673]" -type "float3" -0.0037061572 -0.0069533885 0.0087767243 ;
	setAttr ".pt[674]" -type "float3" 0.0029396415 -0.00096416473 -0.0076451302 ;
...
createNode polyExtrudeFace -n "polyExtrudeFace21";
	...
	setAttr ".ix" -type "matrix" -3.1739437299794035 0 -3.8869600295930876e-16 0 5.1080414559983644e-17 0 -0.4171032382197693 0
		 0 -3.1739437299794035 0 0 -0.99358419442531232 2.5147059028304843 -0.46516457048088206 1;
	setAttr ".ws" yes;
	setAttr ".t" -type "double3" 1.0658141036401503e-14 -2.1316282072803006e-14 -0.88957840373493191 ;
	setAttr ".pvt" -type "float3" -1.009163 2.5177977 3.5170245 ;
	setAttr ".rs" 40956;
	setAttr ".c[0]"  0 1 1;
...
createNode polySplit -n "polySplit1";
	rename -uid "205DE8D2-4B5D-22A5-28B0-ABA7DFB80DFB";
	setAttr -s 53 ".e[0:52]"  1 0.5 0.5 0.530954 0.49760401 0.516487 0.53583199
		 0.551117 0.48726299 0.5 0.464333 0.41937801 0.37348199 0.5 0.48923001 0.54914701
		 0.5 0.50478703 0.551934 0.49981701 0.533889 0.5 0.396916 0.638197 0.5 0.5 0 0.5 0.5
		 0.49972001 0.51196402 0.50713599 0.49892601 0.48414099 0.498714 0.50207698 0.5 0.5
		 0.5 0.5 0.5 0.5 0.5 0.5 0.5 0.5 0.5 0.5 0.5 0.5 0.5 0.5 1;
	setAttr -s 53 ".d[0:52]"  -2147483455 -2147483560 -2147483586 -2147483612 -2147483638 -2147483418 
		-2147483366 -2147483314 -2147483262 -2147483210 -2147483158 -2147483106 -2147483054 -2147483002 -2147482950 -2147482898 -2147482846 -2147482794 
		-2147482742 -2147482690 -2147482638 -2147482586 -2147482534 -2147482482 -2147482430 -2147482367 -2147482369 -2147482328 -2147482404 -2147482456 
		-2147482508 -2147482560 -2147482612 -2147482664 -2147482716 -2147482768 -2147482820 -2147482872 -2147482924 -2147482976 -2147483028 -2147483080 
		-2147483132 -2147483184 -2147483236 -2147483288 -2147483340 -2147483392 -2147483625 -2147483599 -2147483573 -2147483547 -2147483442;
	setAttr ".sma" 180;
	setAttr ".m2015" yes;
select -ne :time1;
	setAttr ".o" 1;
...
connectAttr "polySplit1.out" "camera_lensShape.i";
...
// End of camera_project03.0001.ma
