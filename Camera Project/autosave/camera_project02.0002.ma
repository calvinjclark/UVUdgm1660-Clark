...
//Name: camera_project02.0002.ma
//Last modified: Fri, Oct 30, 2020 10:26:07 AM
//Codeset: 1252
requires maya "2020";
currentUnit -l centimeter -a degree -t film;
fileInfo "exportedFrom" "C:/Users/dwmbs/Desktop/school work uvu/camera project/Camera Project/scenes/camera_project02.ma";
fileInfo "application" "maya";
fileInfo "product" "Maya 2020";
fileInfo "version" "2020";
fileInfo "cutIdentifier" "201911140446-42a737a01c";
fileInfo "osv" "Microsoft Windows 10 Technical Preview  (Build 18363)\n";
fileInfo "UUID" "76B07411-4623-025C-00E6-7D97992F4AA7";
createNode transform -s -n "persp";
	rename -uid "1FF30DD1-4EF5-C0F4-03D8-E5B3294BD055";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.5479306510657054 4.9551192939418023 -11.003958792602372 ;
	setAttr ".r" -type "double3" -11.138352729297338 142.99999999983081 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "49CB3CEF-4DF5-EF8D-72C5-FCA81DA84A14";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 11.988609833344274;
...
createNode transform -n "imagePlane3" -p "images";
	...
	setAttr ".t" -type "double3" -16.881476521950532 3.8536994228280443 0.80804414286045378 ;
	setAttr ".r" -type "double3" 0 90 0 ;
...
createNode polyExtrudeFace -n "polyExtrudeFace10";
	rename -uid "878824A8-40FF-EB04-CAB6-F68A4A9CA159";
	setAttr ".ics" -type "componentList" 1 "f[78:103]";
	setAttr ".ix" -type "matrix" 3.1739437299794035 0 0 0 0 0 0.4171032382197693 0 0 -3.1739437299794035 0 0
		 -0.99358419442531232 2.5147059028304843 -0.46516457048088206 1;
	setAttr ".ws" yes;
	...
	setAttr ".rs" 36922;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" -3.5372139330900616 -0.022749888164527832 -4.409998988569467 ;
	setAttr ".cbx" -type "double3" 1.5812030280885268 5.058346614038971 -4.409998988569467 ;
createNode polyTweak -n "polyTweak6";
	rename -uid "E62B9D29-4EBC-B145-D377-31936436B14F";
	setAttr ".uopa" yes;
	setAttr -s 27 ".tk[313:339]" -type "float3"  -0.10185763 0 0.025105609
		 -0.092889629 0 0.0487522 0.00054256304 0 -0.00010771732 -0.078523248 0 0.069565505
		 -0.059593406 0 0.08633592 -0.037200168 0 0.098088771 -0.012645038 0 0.10414106 0.012645002
		 0 0.10414106 0.037200153 0 0.098088771 0.059593357 0 0.08633592 0.078523174 0 0.069565505
		 0.092889525 0 0.0487522 0.10185753 0 0.02510564 0.10490595 0 3.4309695e-09 0.1018575
		 0 -0.025105659 0.092889525 0 -0.048752233 0.078523174 0 -0.069565468 0.05959332 0
		 -0.086335912 0.037200134 0 -0.098088741 0.012645002 0 -0.10414106 -0.012645029 0
		 -0.10414106 -0.037200153 0 -0.098088741 -0.059593379 0 -0.086335912 -0.078523234
		 0 -0.069565475 -0.09288957 0 -0.048752207 -0.10185759 0 -0.025105666 -0.10490595
		 0 -1.7153793e-08;
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
...
// End of camera_project02.0002.ma
